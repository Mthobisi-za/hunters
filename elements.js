function createElementsLeft({ firstname, lastname, score, index, link }) {
...
function createElementsRight({ firstname, lastname, score, index }) {
    var elemnt = `<div class="div-column-white">
...
function createElementsForMobile({ firstname, lastname, score, index, link }) {
    var elemnt = `<div class="div-column-white">
    <p><span class="star"><img src="${link}" alt=""></span><span class="number">${index}</span></p>
    <p class="text">${firstname} ${lastname}</p>
    <p class="text">${score}</p>
